...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Pipeline":
		...
		case "ContainerEcho":
			...
			return (*Pipeline).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent Pipeline
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Pipeline).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
	...
	case "":
		return dag.Module().
			...
			WithObject(
				dag.TypeDef().WithObject("Pipeline", dagger.TypeDefWithObjectOpts{SourceMap: dag.SourceMap("main.go", 22, 6)}).
					WithFunction(
